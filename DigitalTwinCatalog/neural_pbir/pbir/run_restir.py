...
No two-stage split: avoids cross-stage DrJIT allocator state issues.

Usage:
  python run_restir.py <configroot> <ckptroot> [--gt_envmap_path PATH]
"""
...
# Reduced SPP to fit in ~5 GB available GPU (2048×2048 scene, another 12 GB process running)
